 ...
 * MTN Airtime Service
 * 
 * This file contains utility functions for purchasing MTN airtime through the MTN MoMo API.
 */
...
const MTN_CREDENTIALS = {
  apiKey: 'YOUR_API_KEY', // Replace with your actual API key from the MTN MoMo Developer Portal
  userId: 'YOUR_USER_ID', // Replace with your actual User ID from the MTN MoMo Developer Portal
  subscriptionKey: 'YOUR_SUBSCRIPTION_KEY', // Replace with your actual Subscription Key from the MTN MoMo Developer Portal
...
/**
 * Purchase MTN airtime through MTN MoMo API
 * 
